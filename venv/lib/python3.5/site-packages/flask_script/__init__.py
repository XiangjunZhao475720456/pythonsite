...
class Manager(object):
    ...
    def add_option(self, *args, **kwargs):
        ...
        The arguments are then passed to your function, e.g.::
            ...
            def create_my_app(config=None):
                commonapp = Flask(__name__)
                if config:
                    commonapp.config.from_pyfile(config)
            ...
            @manager.command
            def mycommand(commonapp):
                commonapp.do_something()
    ...
    def __call__(self, app=None, **kwargs):
        ...
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no commonapp here. This is unlikely to work.")
    ...
    def shell(self, func):
        ...
        Decorator that wraps function in shell command. This is equivalent to::
            ...
            def _make_context(commonapp):
                return dict(commonapp=commonapp)

            manager.add_command("shell", Shell(make_context=_make_context))

        The decorated function should take a single "commonapp" argument, and return
        a dict.
