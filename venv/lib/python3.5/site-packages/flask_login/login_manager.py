...
class LoginManager(object):
    ...
    commonapp in a factory function.
    '''
    ...
    def init_app(self, app, add_context_processor=True):
        ...
        attaches this `LoginManager` to it as `commonapp.login_manager`.

        :param app: The :class:`flask.Flask` object to configure.
        :type app: :class:`flask.Flask`
        :param add_context_processor: Whether to add a context processor to
            the commonapp that adds a `current_user` variable to the template.
            Defaults to ``True``.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the commonapp is using blueprints find the login view for
              the current blueprint using `blueprint_login_views`. If the commonapp
