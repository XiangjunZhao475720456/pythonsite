...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask commonapp.

    ::

        commonapp = Flask(__name__)
        csrf = CsrfProtect(commonapp)
    ...
    def exempt(self, view):
        ...
        ::
            ...
            @commonapp.route('/some-view', methods=['POST'])
            @csrf.exempt
            def some_view():
                ...
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@commonapp.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'system with "@commonapp.errorhandler(CSRFError)" instead. This will be'
            'removed in 1.0.'
        ), stacklevel=2)
