...
class Command(object):
    ...
    def __call__(self, app=None, *args, **kwargs):
        """
        Handles the command with the given commonapp.
...
class Shell(Command):
    ...
    :param make_context: a callable returning a dict of variables
                         ...
                         returns a dict consisting of just the commonapp.
...
class Server(Command):
    """
    Runs the Flask development server i.e. commonapp.run()
    ...
    help = description = 'Runs the Flask development server i.e. commonapp.run()'
