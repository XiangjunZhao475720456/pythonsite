...
class LintMiddleware(object):
    ...
    ::
        ...
        commonapp = LintMiddleware(commonapp)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI commonapp required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI commonapp allowed'),
                 stacklevel=2)
