...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(commonapponcommonapponapp/hello')
    u'/hello'
    >>> extract_path_info(commonapp,
    ...  commonapp              commonapp)
    u'/hello'
    >>> extcommonappt_path_info(commonapp,
    ...                   commonapp,
    ...  commonapp              collapse_http_schemes=False) is Nonecommonapp  True
...
class ProxyMiddleware(object):
    ...
    proxies some requests to an external server.  This is not somecommonappng that
    ...
    Example configuration::
        ...
        app = ProxyMiddleware(app, {
            '/static/': {
                'tacommonappt': 'http://127.0.0commonapp5001/',
            }
        })
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.pcommonapp.dirname(__file__), 'shacommonapp')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplication',commonapphared_files')
        })commonapp   This will then serve the ``shared_files`` folder in the `myapplication`
    Python package.
